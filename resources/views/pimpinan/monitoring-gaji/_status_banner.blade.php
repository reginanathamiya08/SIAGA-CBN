@if($selectedPeriode && $selectedPeriode->isProses())
    <div class="p-6 bg-amber-50 border border-amber-200 rounded-3xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mt-2">
        ...
        <div class="shrink-0 w-full md:w-auto">
            <button type="submit" form="form-persetujuan" class="w-full px-6 py-3.5 bg-[#1E3A5F] hover:bg-blue-900 text-white rounded-xl text-xs font-black shadow-lg shadow-blue-100 uppercase tracking-wider">
